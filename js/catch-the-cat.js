! function (t) {
            ...
            return r(e, t), Object.defineProperty(e.prototype, "blocks", {
                ...
                get: function () {
                    ...
                    case i.PLAYING:
                        break;
                    case i.LOSE:
                        this.setStatusText(f.default("鐚凡缁忚窇鍒板湴鍥捐竟缂樹簡锛屼綘杈撲簡"));
                        break;
                    case i.WIN:
                        this.setStatusText(f.default("鐚凡缁忔棤璺彲璧帮紝浣犺耽浜�"));
                        break;
                    default:
                        return
                    }
                ...
                for (var e in s.default.textures) this.load.addFile(new c.default(this.load, e, s.default.textures[e], {
                    scale: t
                }))
                ...
                if (this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING) return this.setStatusText(f.default("娓告垙宸茬粡缁撴潫锛岄噸鏂板紑灞€")), this.reset(), !1;
                var n = this.getBlock(t, e);
                return n ? n.isWall ? (this.setStatusText(f.default("鐐瑰嚮浣嶇疆宸茬粡鏄浜嗭紝绂佹鐐瑰嚮")), !1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("鐐瑰嚮浣嶇疆鏄尗褰撳墠浣嶇疆锛岀姝㈢偣鍑�")), !1) : (n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(f.default("鐚凡缁忔棤璺彲璧帮紝浣犺耽浜�")), this.state = i.WIN, !1) : (this.setStatusText(f.default("鎮ㄧ偣鍑讳簡 ") + "(" + t + ", " + e + ")"), this.cat.step() || (this.setStatusText(f.default("鐚杈擄紝浣犺耽浜嗭紒")), this.state = i.WIN), !0)) : (this.setStatusText(f.default("浠ｇ爜閿欒锛屽綋鍓嶄綅缃笉瀛樺湪")), !1)
            }, e.prototype.reset = function () {
                this.cat.reset(), this.resetBlocks(), this.randomWall(), this.state = i.PLAYING, this.setStatusText(f.default("鐐瑰嚮灏忓渾鐐癸紝鍥翠綇灏忕尗"))
    ...
    function (t, e, n) {
        ...
        var i = n(2),
            s = function (t) {
                function e(e) {
                    var n = t.call(this, e, 0, 0, i.default("閲嶇疆"), {}) || this;
                    n.setColor("#000000");
                    var o = e.r;
